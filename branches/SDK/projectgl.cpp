...
void ProjectGL::SetOnMouseMove(void(*OnMouseMove)(int x,int y))
{
...
void ProjectGL::ListCompile(int arg)
{
    glNewList(DisplayList+arg,GL_COMPILE);
}

void ProjectGL::ListFinish()
{
    glEndList();
}

void ProjectGL::ListExecute(int ListNumber)
{
    glCallList(DisplayList+ListNumber);
}

void ProjectGL::MatrixLoad()
{
    glPopMatrix();
}

void ProjectGL::MatrixSave()
{
    glPushMatrix();
}
...
void ProjectGL::CameraRotate(float a,float x,float y,float z)
{
    //glRotatef(45,x,y,z);
    glRotatef(a,x,y,z);
}

void ProjectGL::CameraMove(float x,float y,float z)
{
    glTranslatef(x,y,z);
}

void ProjectGL::TextureActivate(int texture)
{
...
void ProjectGL::DrawGLScene(float *vertex, float *text, float *normal,int *face,int facei)
{
/* translatekey to:
...
{
    glGenTextures(1,Texture[Texturei]);
    glBindTexture(GL_TEXTURE_2D,Texture[Texturei][0]);
